...
public class DFS
{
    public static List<Node> DepthFirstSearch(Node start, Node goal)
    {
        ...
        while (stack.Count > 0)
        {
            ...
            Console.WriteLine($"\n--- Iteración {iteration} ---");
            Console.WriteLine($"Estado actual: {current.State}");

            // Mostrar la frontera
            Console.Write("Frontera: ");
            ...
            // Mostrar vecinos del estado actual
            Console.Write("Vecinos del estado actual: ");
        ...
        Console.WriteLine("\nNo se encontró una ruta al nodo objetivo.");
